...
_rootNode->evalFunctions.push_back(EVAL_AndNotAnd1AndNot3NotAnd2NotAndTrue); 
_rootNode->constructChildrenNodeFunc = construct_block1;
...
_rootNode->evalFunctions.push_back(EVAL_NotAndNot3NotAnd2); 
_rootNode->evalFunctions.push_back(EVAL_NotAndNotAnd1AndNot3NotAnd2NotAndTrue); 
_rootNode->constructChildrenNodeFunc = construct_block1;
_rootNode->outputStates.resize(2);
_rootNode->inputStates.resize(3);
return _rootNode;
}
...
//Eval
trilean EVAL_AndNotAnd1AndNot3NotAnd2NotAndTrue(Property* _prop){ return AND_3(NOT_3(AND_3(_prop->isEventFired(EVENT_UP), AND_3(NOT_3(_prop->isEventFired(EVENT_RIGHT)), NOT_3(AND_3(_prop->isEventFired(EVENT_DOWN), _prop->inputStates[0]))))), NOT_3(AND_3(TRUE, _prop->inputStates[1])));}

trilean EVAL_NotAndNot3NotAnd2(Property* _prop){ return NOT_3(AND_3(NOT_3(_prop->isEventFired(EVENT_RIGHT)), NOT_3(AND_3(_prop->isEventFired(EVENT_DOWN), _prop->inputStates[0]))));}
trilean EVAL_NotAndNotAnd1AndNot3NotAnd2NotAndTrue(Property* _prop){ return NOT_3(AND_3(NOT_3(AND_3(_prop->isEventFired(EVENT_UP), AND_3(NOT_3(_prop->isEventFired(EVENT_RIGHT)), NOT_3(AND_3(_prop->isEventFired(EVENT_DOWN), _prop->inputStates[0]))))), NOT_3(AND_3(TRUE, _prop->inputStates[1]))));}
